...
module.exports = {
    ...
    async addTutorial(recordId, tutorials) {
        return new Promise((resolve, reject) => {
    ...
    async addAdditionalTutorials(recordId, tutorials) {

        return new Promise((resolve, reject) => {
            pixBase('Acquis').update(recordId,
                {
                    "En savoir plus": tutorials
                },
                (err, record) => {
                    if (err) {
                        return reject(err);
    ...
    async addTag(recordId, tagIds) {
        return new Promise((resolve, reject) => {
            pixBase('Acquis').update(recordId, { "Tags": tagIds },
                (err, record) => {
                    if (err) {
                        return reject(err);
                    } else {
